...
!$omp target update from(d,v1,v2,v3)
!$omp target update from(p,ei,cs)
!$omp target update from(b1,b2,b3,bp)
!$omp target update from(gp)
!$omp target update from(Xcomp)
